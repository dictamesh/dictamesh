...
"""
Sentry Configuration for DictaMesh Framework

This is the main configuration file for the self-hosted Sentry instance
used by the DictaMesh data mesh adapter framework.
"""
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': os.environ.get('SENTRY_DB_PASSWORD', 'sentry_dev_password'),
...
# Security
SECRET_KEY = os.environ.get('SENTRY_SECRET_KEY', 'dictamesh-sentry-secret-key-change-in-production')
